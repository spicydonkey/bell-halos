...
configs.exp.paramVals={0.29,3,2.5,'lowrot'};
...
%% FILES
configs.files.path='\\AMPLPC29\Users\TDC_user\ProgramFiles\my_read_tdc_gui_v1.0.1\dld_output\bell_v2\bell\run_3ms_0.29_1';
...
configs.bec{1}.pos{1}=[1.6525,-3.4e-3,4.5e-3];   % approx condensate locations (z,x,y)
configs.bec{1}.pos{2}=[1.7054,-2.8e-3,4.7e-3];
...
configs.bec{2}.pos{1}=[1.5782,-3.6e-3,3.3e-3];   % approx condensate locations (z,x,y)
configs.bec{2}.pos{2}=[1.6285,-3.1e-3,3.9e-3];

...
configs.exp.paramVals={0.38,3,2.5,'lown'};
...
%% FILES
configs.files.path='\\AMPLPC29\Users\TDC_user\ProgramFiles\my_read_tdc_gui_v1.0.1\dld_output\bell_v2\bell\run_3ms_0.38_lown_1';

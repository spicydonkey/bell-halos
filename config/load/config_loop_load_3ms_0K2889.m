...
configs.exp.name='loop';
configs.exp.paramNames={'ampRaman','delay','intRaman',''};
configs.exp.paramVals={0.2889,3,2.5,''};
...
%% FILES
configs.files.path='\\AMPLPC29\Users\TDC_user\ProgramFiles\my_read_tdc_gui_v1.0.1\dld_output\bell_v2\loop_3ms\1_0.2889_v3.1';

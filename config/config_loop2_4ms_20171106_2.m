...
%% FILES
configs.files.path_loop='\\amplpc29\Users\TDC_user\ProgramFiles\my_read_tdc_gui_v1.0.1\dld_output\bell_v2\loop_4ms';      % local operation path
...
configs.bec{1}.Rmax=12e-3;      % max condensate sph radius

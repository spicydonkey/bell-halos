...
%% FILES
configs.files.path_loop='\\amplpc29\Users\TDC_user\ProgramFiles\my_read_tdc_gui_v1.0.1\dld_output\bell_v2\loop_3ms_hipower';      % local operation path
...
configs.bec{1}.pos{1}=[1.6537,-3.4e-3,4.0e-3];   % approx condensate locations (z,x,y)
configs.bec{1}.pos{2}=[1.7070,-3.0e-3,4.9e-3];
...
configs.bec{2}.pos{1}=[1.5784,-3.0e-3,2.6e-3];   % approx condensate locations (z,x,y)
configs.bec{2}.pos{2}=[1.6300,-3.4e-3,3.5e-3];

...
%% FILES
% configs.files.path='\\AMPLPC29\Users\TDC_user\ProgramFiles\my_read_tdc_gui_v1.0.1\dld_output\bell_progress_201709\mix_mf_1\mix_5\d';
configs.files.path='\\AMPLPC29\He BEC Archive\EXPERIMENT-DATA\spinmom_bell\bell_v1\mix_mf_1\mix_5\d';
...
configs.load.id=1:54;         % file id numbers to use for analysis
...
configs.bell_lo.ampRaman=0.12;     % Raman amplitude (mixing), K_R_mix
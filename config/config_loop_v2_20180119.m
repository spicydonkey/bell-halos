...
%
% 20180119
%   checking for local defects in rotation map by sampling high-res
%   data only mf=1 (at exactly 0.38 - experimental condition)
%
...
%% FILES
configs.files.path_loop='C:\Users\HE BEC\bell\raw_data\loop_3ms';
...
% configs.zone.lim=[3,Inf];

% same as stripy Bell settings
configs.zone.nazim=200;
configs.zone.nelev=100;
configs.zone.histtype='simple';
configs.zone.sig=0.05;
configs.zone.lim=[];

% config for Ramsey interferometry for long delay
%
% 2018.04.09
% DKS
% 
...
%%% mf
configs.mf(1).mf=1;
configs.mf(1).window={vz*[0.3807,0.3994],35e-3*[-1,1],35e-3*[-1,1]};
configs.mf(1).p_bec0=[vz*0.3839,  1.2e-3,    -2.7e-3;
                   vz*0.397,  1.2e-3,    -2.7e-3];
configs.mf(1).r_bec0=15e-3;

configs.mf(2).mf=0;
configs.mf(2).window={vz*[0.3994,0.4165],35e-3*[-1,1],35e-3*[-1,1]};
configs.mf(2).p_bec0=[vz*0.4008,  -0.3e-3,    2.9e-3;
                    vz*0.4135,  -0.3e-3,    2.9e-3];

...
%
% 2018.05.04: EXP1_5: violation of inequality
%
% DKS
%

%%% configs
path_src='C:\Users\HE BEC\bell\2018april\exp1_5\src';
...
%     g2corr_par(ii)=max([tg2{1}(15,15,15),tg2{2}(15,15,15)]);     
    ...
    E_par(ii)=g2toE(g2corr_par(ii),g2anti_par(ii));
end

% vis
figure;
plot(par_T/10e-6,E_par,'o');
ylim([-1,1]);
xlim([0,1]);
...
%%% CONFIG
subset_shotsize=500;    % shot-size of bootstrap sampled subset
n_subset=30;            % no. of bootstrap repeats
...
disp([E_bootstrap_mean,E_bootstrap_sdev]);

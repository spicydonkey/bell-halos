...
configs.path.base='C:\Users\HE BEC\bell_data\exp1_attack_inequality\3';
...
%%% halo centering
configs.post.Dk{1}=[-0.007,-0.01,0];
configs.post.Dk{2}=[0.018,0.02,0];
